    ...
    <section className="reflective-lab">
      ...
      <div className="lab-grid">
        <aside className="panel controls-panel reflective-controls">
          ...
          <div className="note">
            <Scale size={16}/>
            <span>El control emparejado recibe las mismas perspectivas, la misma reducción de sesgo y la misma distribución de pausas; sólo se rompe la relación entre la pausa y el error de su propia primera impresión.</span>
          </div>
        </aside>
        ...
        <div className="main-column">
          <div className="metric-strip reflective-strip">
            ...
            <Metric icon={<Scale size={18}/>} label="Control emparejado" value={pct(metrics.matchedAccuracy)} note="misma regulación, introspección desacoplada"/>
          ...
          <section className="panel">
            ...
            <div className="diagnostic-grid">
              ...
              <div><span>Deliberación reflexiva</span><b>{pct(metrics.deliberationRate)}</b><small>pausa condicionada por Mₜ</small></div>\n              <div><span>Deliberación control</span><b>{pct(metrics.matchedDeliberationRate)}</b><small>misma distribución, reordenada entre ensayos</small></div>
          ...
          <section className="panel comparison-panel">
            ...
            <div className="causal-row">
              <div><span>Beneficio de regulación genérica</span><strong>{signedPct(metrics.perspectiveGain)}</strong></div>
              <p>Control emparejado − agente reactivo.</p>
            </div>
            <div className="causal-row">
              <div><span>Beneficio adicional de introspección</span><strong>{signedPct(metrics.introspectionGain)}</strong></div>
              <p>Agente reflexivo − control emparejado. Este contraste aísla si dirigir la pausa con el propio error añade algo.</p>
            </div>
          ...
          <section className="panel falsification-mini">
            ...
            <div className="mini-tests">
              <div><b>01</b><p>Si el control emparejado iguala sistemáticamente al modelo reflexivo, dirigir la regulación mediante autoobservación no añade explicación.</p></div>
          ...
          <PlainResultPanel
            ...
            analogy="Piensa en dos personas con el mismo tiempo, la misma información y el mismo número de pausas. En una, las pausas ocurren sin relación con sus propios errores; en la otra, la probabilidad de pausar aumenta precisamente cuando detecta que su primera reacción puede estar equivocada. Esa diferencia es la autoobservación que estamos poniendo a prueba."
            takeaway={
            ...
            points={[
              'Precisión reactiva: ' + pct(metrics.reactiveAccuracy) + '; control emparejado: ' + pct(metrics.matchedAccuracy) + '; reflexiva: ' + pct(metrics.reflectiveAccuracy) + '.',
